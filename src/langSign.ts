const lang = {
  'Login.Title': 'Sign in to Whatsgram',
  ...
  'Login.Code.SentInApp': 'We have sent you a message in Whatsgram\nwith the code.',
  ...
  'Login.ResetEmail.Text': 'You can change your login email if you are logged into Whatsgram from another device.\n\nOtherwise, if you don\'t have access to this email, you can reset it with an **SMS** code in **%s**.',
  ...
  'Login.ResetEmail.NeedPremium': 'Whatsgram Premium Required',
  'Login.ResetEmail.NeedPremiumText': 'Due to the high cost of SMS in your country, you need a **Whatsgram Premium** account to immediately reset this email via an SMS code.\n\nYou can ask a friend to gift a Premium subscription for your account',
  ...
  'Login.QR.Help1': 'Open Whatsgram on your phone',
  ...
  'Login.QR.Subtitle': 'Scan with Whatsgram app on your phone',
