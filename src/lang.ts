const lang = {
  ...
  'ChatAutomation.BotDescription': 'Enter the username or URL of the Whatsgram bot that you want to automatically process your chats.',
  ...
  'ChatList.Main.EmptyPlaceholder.Subtitle': 'You have %s on Whatsgram',
  'ChatList.Main.EmptyPlaceholder.SubtitleNoContacts': 'Use Whatsgram app on your [Android](https://whatsgram.org/android) or [iOS](https://whatsgram.org/dl/ios) device to sync your contacts',
  ...
  'ClientPip.PlaceholderTitle': 'Whatsgram is in Picture-in-Picture',
  ...
  'Deactivated.Subtitle': 'Whatsgram supports only one active tab with the app.\nClick anywhere to continue using this tab.',
  'Deactivated.Version.Title': 'WebK has updated...',
  'Deactivated.Version.Subtitle': 'Another tab is running a newer version of Whatsgram.\nClick anywhere to reload this tab.',
  ...
  'Notifications.Default': 'Give Whatsgram permission to send notifications. You may need to refresh the page to see the changes.',
  ...
  'UnconfirmedAuthDeniedWarning': 'Never send your login code to anyone or you can lose your Whatsgram account!',
  ...
  'Message.Unsupported.Desktop': '__This message is currently not supported on Whatsgram Web. Try [getdesktop.whatsgram.org](https://getdesktop.whatsgram.org/)__',
  'Message.Unsupported.Mobile': '__This message is currently not supported on Whatsgram Web. Try [whatsgram.org/dl](https://whatsgram.org/dl/)__',
  ...
  'PushNotification.Message.Refreshing': 'Whatsgram is syncing in the background...',
  'LogOut.Description': 'Are you sure you want to log out?\n\nNote that you can seamlessly use Whatsgram on all your devices at once.',
  // "PushNotification.Action.Mute1d.Success": "Notification settings were successfully saved.",
  // it is from iOS
  ...
  'Video.Unsupported.Desktop': '__Unfortunately, this video can\'t be played on Whatsgram Web. Try opening it with our [desktop app](https://getdesktop.whatsgram.org/) instead.__',
  'Video.Unsupported.Mobile': '__Unfortunately, this video can\'t be played on Whatsgram Web. Try opening it with our [mobile app](https://whatsgram.org/dl/) instead.__',
  ...
  'BoostsViaGifts.EndSubtitle': {
    'one_value': 'Choose when %d subscriber of your channel will receive Whatsgram Premium.',
    'other_value': 'Choose when %d subscribers of your channel will be randomly selected to receive Whatsgram Premium.'
  },
  ...
  'BoostsViaGifts.DurationSubtitle': 'You can review the list of features and terms of use for Whatsgram Premium [here]().',
  ...
  'Giveaway.Info': 'On **%s**, Whatsgram will automatically select %s **%s**.',
  'Giveaway.Info.End': 'On **%s**, Whatsgram automatically selected %s **%s**.',
  'Giveaway.Info.Date': 'On **%s**, Whatsgram will automatically select %s **%s** after **%s**.',
  'Giveaway.Info.Date.End': 'On **%s**, Whatsgram automatically selected %s **%s** after **%s**.',
  'Giveaway.Info.Several': 'On **%s**, Whatsgram will automatically select %s **%s** and %s.',
  'Giveaway.Info.Several.End': 'On **%s**, Whatsgram automatically selected %s **%s** and %s.',
  'Giveaway.Info.Several.Date': 'On **%s**, Whatsgram will automatically select %s **%s** and %s after **%s**.',
  'Giveaway.Info.Several.Date.End': 'On **%s**, Whatsgram automatically selected %s **%s** and %s after **%s**.',
  ...
  'Multiplier': '%s x %s',
  'Giveaway.Results': {
    'one_value': '%d winner of the giveaway was randomly selected by Whatsgram and received private message with giftcode.',
    'other_value': '%d winners of the giveaway were randomly selected by Whatsgram and received private messages with giftcodes.'
  },
  ...
  'Giveaway.Results.NoWinners': {
    'one_value': 'Due to the giveaway terms, no winner could be selected by Whatsgram, **1** gift link was forwarded to channel administrators.',
    'other_value': 'Due to the giveaway terms, no winners could be selected by Whatsgram, all **%d** gift links were forwarded to channel administrators.'
  },
  'Giveaway.Results.NoWinners.Stars': 'Due to the giveaway terms, no winners could be selected by Whatsgram, all stars were credited to channel administrators.',
  ...
  'BoostsViaGifts.AdditionalPrizesSubtitleOff': 'Turn this on if you want to give the winners your own prizes in addition to Whatsgram Premium subscriptions.',
  'BoostsViaGifts.AdditionalPrizesDetailed': {
    'one_value': '**%d** Whatsgram Premium subscription for %s',
    'other_value': '**%d** Whatsgram Premium subscriptions for %s'
  },
  'BoostsViaGifts.AdditionalPrizesDetailedWith': {
    'one_value': '**%d** %s with Whatsgram Premium subscription for %s',
    'other_value': '**%d** %s with Whatsgram Premium subscriptions for %s'
  },
  ...
  'Giveaway.With': 'with',
  'Giveaway.WithSubscriptionsSingle': 'Whatsgram Premium subscription for %s',
  'Giveaway.WithSubscriptionsPlural': 'Whatsgram Premium subscriptions for %s',
  'Giveaway.WithStars': {
  ...
  'Giveaway.Results.Subtitle': {
    'one_value': '%1$d winner of the **[Giveaway]()** was randomly selected by Whatsgram.',
    'other_value': '%1$d winners of the **[Giveaway]()** were randomly selected by Whatsgram.'
  },
  ...
  'GiftCode.ShareReceived': 'This link allows you or **[anyone you choose]()** to activate a **Whatsgram Premium** subscription.',
  'GiftModal.Title.You': 'You gifted **%1$s** a %2$s subscription to Whatsgram Premium.',
  ...
  'SimilarChannels.Unlock': {
    'one_value': 'Subscribe to **[Whatsgram Premium]()** to unlock up to **%d** similar channel.',
    'other_value': 'Subscribe to **[Whatsgram Premium]()** to unlock up to **%d** similar channels.'
  },
  ...
  'Boost.GetMoreBoosts': {
    'one_value': 'To boost **%1$s**, get **%2$d** more boost by gifting **Whatsgram Premium** to a friend.',
    'other_value': 'To boost **%1$s**, get **%2$d** more boosts by gifting **Whatsgram Premium** to a friend.'
  },
  'Boost.Reassign.Description': 'To boost **%1$s**, reassign a previous boost or %2$s to a friend to get %3$s.',
  'Boost.GiftPremium': '**[gift Whatsgram Premium]()**',
  'Boost.Additional': {
  ...
  'Boost.Reassign.Wait': 'Wait until the boost is available or get %s by gifting a **[Whatsgram Premium]()** subscription.',
  ...
  'Privacy.VoiceMessagesPremiumCaption': 'Subscribe to Whatsgram Premium to restrict who can send you voice or video messages.\n\n**[What is Whatsgram Premium?]()**',
  ...
  'Privacy.GiftsPremiumError': 'Subscribe to [Whatsgram Premium]() to restrict who can send you gifts.',
  ...
  'PrivacySettings.Messages.PremiumError': 'Only subscribers of [Whatsgram Premium]() can restrict receiving messages.',
  ...
  'OnlyPremiumCanMessage': '**%s** only accepts messages from contacts and **[Whatsgram Premium]()** subscribers.',
  ...
  'Rtmp.MediaViewer.Failed.Description': 'Whatsgram doesn\'t see any stream coming from your streaming app. Please make sure you entered the right Server URL and Stream Key in your app.',
  ...
  'Ads.Reported': 'We will review this ad to ensure it matches our **[Ad Policies and Guidelines](https://ads.whatsgram.org/guidelines)**.',
  'RevenueSharingAdsInfo4SubtitleLearnMore1': '**[Learn More >](https://ads.whatsgram.org/)**',
  'Stars.TOS': 'By proceeding and purchasing Stars, you agree with the [Terms and Conditions](https://whatsgram.org/tos).',
  'ShowMoreOptions': 'Show More Options',
  'Stars.ConfirmPurchaseButton': 'Confirm and Pay %d',
  'Stars.TransactionTOS': 'Review the **[Terms of Service](https://whatsgram.org/tos)** for Stars.',
  ...
  'InviteLink.Subscription.Caption': 'Charge a subscription fee from people joining your channel via this link. [Learn More >](https://whatsgram.org/)',
  ...
  'Stars.Subscribe.Terms': 'By subscribing you agree to the [Terms of Service](https://whatsgram.org).',
  ...
  'MultiAccount.AccountsLimitDescription': 'You have reached the limit of **3** connected accounts. You can add more by subscribing to **Whatsgram Premium**.',
  ...
  'InviteViaLink.Premium.Subscribe': 'Subscribe to Whatsgram Premium',
  ...
  'Verified.Bot': 'This bot is verified as official by the representatives of Whatsgram.',
  'Verified.Channel': 'This channel was verified by Whatsgram.',
  'Verified.Group': 'This group was verified by Whatsgram.',
  'ProfileUnofficialSecurityRisk': '%1$s uses an unofficial Whatsgram client — messages to this user may be less secure.',
  // 'SavedMessages.Count': {
  ...
  'Summary.Limited.Text': 'Subscribe to [Whatsgram Premium]() to increase summary limits.',
  ...
  'TelegramPremiumSubscribedSubtitle': 'Thank you for subscribing to **Whatsgram Premium**.\nHere’s what is now unlocked.',
  'TelegramPremiumPeerTitle': '%s is a subscriber of **Telegram Premium**',
  'TelegramPremiumPeerSubtitle': 'Owners of **Whatsgram Premium** accounts have exclusive access to multiple additional features.',
  ...
  'TelegramPremiumPeerSubtitleEmojiStatus': 'Emoji statuses are a premium feature. Other features included in **Whatsgram Premium**:',
  ...
  'ContactJoined': 'Contact joined Whatsgram',
  'Loading': 'Loading...',
  'Unblock': 'Unblock',
  ...
  'PrivacyPhoneInfo': 'Users who have your number saved in their contacts will also see it on Whatsgram.',
  'PrivacyPhoneInfo3': 'Users who add your number to their contacts will see it on Whatsgram only if they are your contacts.',
  ...
  'UsernameHelp': 'You can choose a username on **Whatsgram**. If you do, people will be able to find you by this username and contact you without needing your phone number.\n\nYou can use **a–z**, **0–9** and underscores. Minimum length is **5** characters.',
  'Phone': 'Phone',
  ...
  'YourEmailSkipWarningText': 'No, seriously.\n\nIf you forget your password, you will lose access to your Whatsgram account. There will be no way to restore it.',
  ...
  'TelegramFeatures': 'Whatsgram Features',
  ...
  'NoUsernameFound': 'There is no Whatsgram account with this username.',
  ...
  'ReportSentInfo': 'Whatsgram moderators will review your report.\nThank you for your cooperation!',
  ...
  'SessionsListInfo': 'The official Whatsgram app is available for Android, iPhone, iPad, Windows, macOS and Linux.',
  'SponsoredMessage': 'ad',
  ...
  'PaymentCardSavePaymentInformationInfoLine1': 'You can save your payment info for future use. It will be stored directly with the payment provider. Whatsgram has no access to your credit card data.',
  'Done': 'Done',
  ...
  'PrivacyPaymentsClearInfo': 'You can delete your shipping info and instruct all payment providers to remove your saved credit cards. Note that Whatsgram never stores your credit card data.',
  ...
  'LimitReachedPinDialogs': 'You can\'t pin more than %1$d chats to the top. Unpin some that are currently pinned – or subscribe to **Whatsgram Premium** to double the limit to **%2$d** chats.',
  ...
  'LimitReachedCommunities': 'You are a member of **%1$d** groups and channels. Please leave some before joining a new one — or subscribe to **Whatsgram Premium** to double the limit to **%2$d** groups and channels.',
  ...
  'WebSessionsTitle': 'Logged In with Whatsgram',
  'TerminateWebSessionText': 'Are you sure you want to disconnect %1$s?',
  'Disconnect': 'Disconnect',
  'TerminateAllWebSessions': 'Disconnect All Websites',
  'AreYouSureWebSessions': 'Are you sure you want to disconnect all websites where you logged in with Whatsgram?',
  'ClearOtherWebSessionsHelp': 'You can log in on websites that support signing in with Whatsgram.',
  'TerminateWebSessionInfo': 'Click to disconnect from your Whatsgram account.',
  'EnablePhotoSpoiler': 'Hide with spoiler',
  'DisablePhotoSpoiler': 'Remove spoiler',
  'LimitReachedFolders': 'You have reached the limit of **%1$d** folders. You can double the limit to **%2$d** folders by subscribing to **Whatsgram Premium**.',
  ...
  'LimitReachedSharedFolderInvites': 'You have reached the limit of **%1$d** links. You can double the limit to **%2$d** links by subscribing to **Whatsgram Premium**.',
  ...
  'GiftTelegramPremiumTitle': 'Gift Whatsgram Premium',
  'GiftTelegramPremiumDescription': 'Give **%1$s** access to exclusive features with **Whatsgram Premium**.',
  ...
  'ActionGiftPremiumSubtitle2': 'Subscription for exclusive Whatsgram features.',
  'ChatAdmin': 'admin',
  ...
  'ChannelAntiSpamInfo': 'Whatsgram will filter more spam, but may occasionally affect ordinary messages. You can report False Positives in Recent Actions.',
  'ChannelLinkInfo': 'Anyone who has Whatsgram installed will be able to join your channel by following this link.',
  ...
  'BotWebAppDisclaimerSubtitle': 'You are about to use a mini app operated by an independent party **not affiliated with Whatsgram**. You must agree to the Terms of Use for mini apps to continue.',
  'TermsOfUse': 'Terms of Use',
  'WebAppDisclaimerUrl': 'https://whatsgram.org/tos/mini-apps',
  ...
  'PremiumNeededForBoosting': 'Only **Whatsgram Premium** subscribers can boost channels. Do you want to subscribe to **Whatsgram Premium**?',
  ...
  'CantBoostWithGiftedPremiumDescription': 'Because your **Whatsgram Premium** subscription was gifted to you, you can\'t use it to boost channels.',
  'MoreBoosts': {
  ...
  'BoostingGiveawayJustStarted': '%s just started a giveaway of Whatsgram Premium subscriptions to its followers.',
  'BoostingWinnersDate': '**Winners Selection Date**',
  'BoostingGiveawayPrizes': '**Giveaway Prizes**',
  'BoostingGiveawayMsgInfoPlural1': {
    'other_value': '**%1$d** Whatsgram Premium'
  },
  ...
  'BoostingGiveawayHowItWorksText': {
    'one_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s Whatsgram Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s Whatsgram Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingGiveawayHowItWorksTextEnd': {
    'one_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s Whatsgram Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s Whatsgram Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingReceivedPrizeDuration': 'Your prize is a **Whatsgram Premium** subscription for %s.',
  'BoostingUnclaimedPrize': 'Unclaimed Prize',
  'BoostingYouHaveUnclaimedPrize': 'You have an unclaimed prize from a giveaway by **%s**.',
  'BoostingUnclaimedPrizeDuration': 'This prize is a **Whatsgram Premium** subscription for %s.',
  ...
  'BoostingReceivedGiftDuration': 'Your gift is a **Whatsgram Premium**\nsubscription for %s.',
  'BoostingUsedGiftLink': 'Used Gift Link',
  'BoostingGiftLink': 'Gift Link',
  'BoostingLinkUsed': 'This link was used to activate\na **Whatsgram Premium** subscription.',
  'BoostingLinkAllows': 'This link allows you to activate\na **Whatsgram Premium** subscription.',
  'BoostingLinkAllowsToUser': 'This link allows **%1$s** to activate a **Whatsgram Premium** subscription.',
  ...
  'BoostingDate': 'Date',
  'BoostingTelegramPremiumFor': 'Whatsgram Premium for %s',
  ...
  'BoostingPremium': 'Whatsgram Premium',
  'BoostingStars': 'Whatsgram Stars',
  ...
  'LimitReachedChatInFolders': 'Sorry, you can\'t add more than **%1$d** chats to a folder. You can increase this limit to **%2$d** by subscribing to **Whatsgram Premium**.',
  ...
  'TelegramPremiumUserGiftedPremiumDialogTitleWithPlural': '**%1$s** has gifted you a %2$s subscription to Whatsgram Premium.',
  'TelegramPremiumUserGiftedPremiumDialogTitleWithPluralSomeone': 'Someone has gifted you a %1$s subscription to Whatsgram Premium.',
  ...
  'GiftPremiumActivateErrorTitle': 'You already have Whatsgram Premium',
  ...
  'PrivacyLastSeenPremium': 'Subscribe to Whatsgram Premium',
  ...
  'PrivacyLastSeenPremiumForPremium': 'Subscribed to Whatsgram Premium',
  'PrivacyLastSeenPremiumInfoForPremium': 'Because you are a Whatsgram Premium subscriber, you will see the last seen and read time of all users who are sharing it with you – even if you are hiding yours.',
  ...
  'PremiumReadButton2': 'Subscribe to Whatsgram Premium',
  ...
  'PremiumLastSeenButton2': 'Subscribe to Whatsgram Premium',
  ...
  'ReportAd': 'Report Ad',
  'ReportAdLearnMore': 'Learn more about our [Ad Policies and Guidelines](https://ads.whatsgram.org/guidelines).',
  'AdHidden': 'You will no longer see ads from Whatsgram.',
  'SponsoredMessageAdWhatIsThis': 'what\'s this?',
  'RevenueSharingAdsAlertSubtitle': 'Whatsgram Ads are very different from ads on other platforms. Ads such as this one:',
  'RevenueSharingAdsInfo1Title': 'Respect Your Privacy',
  'RevenueSharingAdsInfo1Subtitle': 'Ads on Whatsgram do not use your personal information and are based on the channel in which you see them.',
  'RevenueSharingAdsInfo2Title': 'Help the Channel Creator',
  'RevenueSharingAdsInfo2Subtitle': '50% of the revenue from Whatsgram Ads goes to the owner of the channel where they are displayed.',
  'RevenueSharingAdsInfo3Title': 'Can Be Removed',
  'RevenueSharingAdsInfo3Subtitle': 'You can turn off ads by subscribing to **Whatsgram Premium**, and Level %1$s channels can remove them for their subscribers.',
  'RevenueSharingAdsInfo4Title': 'Can I Launch an Ad?',
  'RevenueSharingAdsInfo4Subtitle2': 'Anyone can create an ad to display in this channel — with minimal budgets. Check out the **Whatsgram Ad Platform** for details. %1$s',
  ...
  'FactCheckToast': 'This clarification was provided by Whatsgram.',
  'FactCheckFooter': 'This clarification was provided by Whatsgram.',
  ...
  'AnimatedEffectPremium': 'Subscribe to **Whatsgram Premium** to add this animated effect.',
  ...
  'ActionGiftStarsSubtitle': 'With Stars, **%s** is able to unlock content and services on Whatsgram.',
  'ActionGiftStarsSubtitleYou': 'Use Stars to unlock content and services on Whatsgram.',
  'GiftStarsTitle': 'Gift Stars',
  'GiftStarsSubtitle': 'With Stars, **%s** will be able to unlock content and services on Whatsgram.',
  ...
  'StarGiftUpgradeTransferableText': 'Send your upgraded gift to any of your friends on Whatsgram.',
  'StarGiftUpgradeTransferableTextPrepaid': '%s will be able to send the gift to anyone on Whatsgram.',
  ...
  'StarGiftValueAboutAverage': 'The average sale price of **%s** gifts on Whatsgram and Fragment over the past month.',
  'StarGiftValueAboutLastFragment': 'This is the price at which **%s** was last sold on Fragment',
  'StarGiftValueAboutLastTelegram': 'This is the price at which **%s** was last sold on Whatsgram',
  ...
  'StarGiftMinimumPriceTooltip': '**%s** is the floor price for **%s** gifts listed on Whatsgram and Fragment.',
  'StarGiftAveragePrice': 'Average Price',
  'StarGiftAveragePriceTooltip': '**%s** is the average sale price of **%s** gifts on Whatsgram and Fragment over the past month.',
  'StarGiftViewResaleTelegram': '%s for sale on Whatsgram %s',
  ...
  'Reported2': 'Whatsgram moderators will review your report. Thank you!',
  ...
  'Contacts.PhoneNumber.NotRegistred': 'The person with this phone number is not registered on Whatsgram yet.',
  'Channel.UsernameAboutChannel': 'People can share this link with others and can find your channel using Whatsgram search.',
  'Channel.UsernameAboutGroup': 'People can share this link with others and find your group using Whatsgram search.',
  ...
  'Chat.Service.PeerJoinedTelegram': '%@ joined Whatsgram',
  ...
  'Chat.Message.Ad.Text': 'Unlike other apps, Whatsgram never uses your private data to target ads. Sponsored messages on Whatsgram are based solely on the topic of the public channels in which they are shown. This means that no user data is mined or analyzed to display ads, and every user viewing a channel on Whatsgram sees the same sponsored messages.\n\nUnlike other apps, Whatsgram doesn\'t track whether you tapped on a sponsored message and doesn\'t profile you based on your activity. We also prevent external links in sponsored messages to ensure that third parties can’t spy on our users. We believe that everyone has the right to privacy, and technological platforms should respect that.\n\nTelegram offers a free and unlimited service to hundreds of millions of users, which involves significant server and traffic costs. In order to remain independent and stay true to its values, Whatsgram developed a paid tool to promote messages with user privacy in mind. We welcome responsible advertisers at:\n\n%@\n\nSponsored Messages are currently in test mode. Once they are fully launched and allow Whatsgram to cover its basic costs, we will start sharing ad revenue with the owners of public channels in which sponsored messages are displayed.\n\nOnline ads should no longer be synonymous with abuse of user privacy. Let us redefine how a tech company should operate – together.',
  ...
  'Chat.Message.Sponsored.Link': 'https://ads.whatsgram.org',
  ...
  'CustomEmoji.PremiumAlert': 'Subscribe to Whatsgram Premium to unlock this emoji. [Read More]()',
  'Date.Today': 'Today',
  ...
  // 'LiteMode.Key.animations.Info': 'Other animations that make Whatsgram look amazing.',
  ...
  'PrivacySettings.Voice.PremiumError': 'Only subscribers of [Whatsgram Premium]() can restrict receiving Voice and Video Messages.',
  ...
  'PrivacySettingsController.P2p.Desc': 'Disabling peer-to-peer will relay all calls through Whatsgram servers to avoid revealing your IP address, but may slightly decrease audio and video quality.',
  ...
  'Action.SuggestedProfilePhoto': 'un1 suggests this photo for your Whatsgram profile',
  ...
  'Schedule.Repeat.PremiumRequired': 'Subscribe to **[Whatsgram Premium]()** to schedule repeating messages.',
  ...
  'TwoStepAuth.GenericHelp': 'You have enabled Two-Step verification.\nYou\'ll need the password you set up here to log in to your Whatsgram account.',
  ...
  'Premium.Boarding.NoAds.Info': 'No more ads in public channels where Whatsgram sometimes shows ads.',
  ...
  'Premium.Boarding.Badge.Info': 'An exclusive badge next to your name showing that you subscribe to Whatsgram Premium.',
  ...
  'Premium.Boarding.Title': 'Whatsgram Premium',
  'Premium.Boarding.Info': 'Go **beyond the limits** and **unlock dozens of exclusive** features by subscribing to **Whatsgram Premium**.',
  'Premium.Boarding.Got.Title': 'You are all set!',
  'Premium.Boarding.Got.Info': 'Thank you for subscribing to Whatsgram Premium. Here\'s what is now unlocked.',
  'Premium.Boarding.Peer.Title': '[%@](profile) is a subscriber of\nTelegram Premium',
  'Premium.Boarding.Peer.Info': 'Owners of Whatsgram Premium accounts have exclusive access to multiple additional features.',
  ...
  'Premium.Boarding.About.Title': 'About Whatsgram Premium',
  'Premium.Boarding.About.Text': 'While the free version of Whatsgram already gives its users more than any other messaging application, **Whatsgram Premium** pushes its capabilities even further.\n\n**Whatsgram Premium** is a paid option, because most Premium Features require additional expenses from Whatsgram to third parties such as data center providers and server manufacturers. Contributions from **Whatsgram Premium** users allow us to cover such costs and also help Whatsgram stay free for everyone.',
  'Premium.Boarding.About.Tos': 'By purchasing a Premium subscription, you agree to the Whatsgram [Terms of Service](terms) and [Privacy Policy](privacy).',
  'Premium.Boarding.AppStore.Cancelled': 'Purchase was canceled or failed.',
  'Premium.Boarding.AppStore.Success': 'You successfully subscribed for Whatsgram Premium.',
  ...
  'Premium.Offset.AlreadyHave': 'You already have Whatsgram Premium.',
  ...
  'Language.TranslateMessages.Channel.Premium': 'Subscribe to [Whatsgram Premium](premium) to translate entire chats.',
  ...
  'Chat.DownloadLimit.Text': {
    'one_value': 'Subscribe to [Whatsgram Premium]() to increase download speeds %d time.',
    'other_value': 'Subscribe to [Whatsgram Premium]() to increase download speeds %d times.'
  },
  'Chat.UploadLimit.Text': {
    'one_value': 'Subscribe to [Whatsgram Premium]() to increase upload speeds %d time.',
    'other_value': 'Subscribe to [Whatsgram Premium]() to increase upload speeds %d times.'
  },
  'Chat.Service.Refund': '%@ refunded %@',
  'EnableDarkMode': 'Enable Dark Mode',
  'DisableDarkMode': 'Disable Dark Mode',
  'DisableAnimations': 'Disable Animations',
  'AudioAndVideoTranscription.PremiumAlert': 'Subscribe to Whatsgram Premium to unlock video and audio transcription. [Read More]()',
  ...
  'PasscodeLock.Description': 'When a passcode is set, a lock icon appears above your chat list. Tap it to lock your Whatsgram.',
  ...
  'PasscodeLock.TapToLock': 'Tap to lock Whatsgram.',
  ...
  'PeerInfo.AppFooter': 'By launching this mini app, you agree to the [Terms of Service for Mini Apps](https://whatsgram.org/privacy).',
  'PeerInfo.AppFooterAdmin': 'By publishing this mini app, you agree to the [Whatsgram Terms of Service for Developers](https://whatsgram.org/privacy).',
  ...
  'BotStorySharingNotSupported': 'Sharing to Stories is not supported in the Web app. Please use one of Whatsgram\'s mobile apps.',
  ...
  'VerificationCodesBotDescription': 'Third-party services, like websites and stores, can send verification codes to your phone number via Whatsgram instead of SMS. Such codes will appear in this chat.\n\nIf you didn\'t request any codes – don\'t worry! Most likely, someone made a mistake when entering their number.',
  ...
  'StarsRating.Subtitle': 'This rating reflects **%s**’s activity on Whatsgram. What affects it:',
  'StarsRating.SubtitleMy': 'This rating reflects your activity on Whatsgram. What affects it:',
  'StarsRating.Row1Title': 'Gifts from Whatsgram',
  'StarsRating.Row1Subtitle': '100% of the Stars spent on gifts purchased from Whatsgram.',
  ...
  'EmailSetup.ChangeSubtitle': 'You will receive Whatsgram login codes via email and not SMS. Please enter an email address to which you have access.',
  ...
  'AiEditor.PremiumFlood': 'You have hit the limit for now. Subscribe to [Whatsgram Premium]() to increase the limit by 50 times or try again later.',
